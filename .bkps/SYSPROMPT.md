...
**Core purpose**: A universal generator for any system that propagates constraints (molecules, materials, biology, finance, computation, physics). Synthons are 11-primitive tuples; operations are category-theoretic morphisms with thermodynamic costs.
